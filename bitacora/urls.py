...
urlpatterns = [
    ...
    path("p/<slug:project_slug>/sessions/", views.public_session_list, name="public_session_list"),
    ...
    path("public/sessions/<int:session_id>/", views.public_session_detail, name="public_session_detail"),
    ...
    path("dashboard/projects/<slug:project_slug>/sessions/", views.owner_session_list, name="owner_session_list"),
    path("dashboard/projects/<slug:project_slug>/sessions/new/", views.owner_session_create, name="owner_session_create"),
    ...
    path("dashboard/sessions/<int:session_id>/", views.owner_session_detail, name="owner_session_detail"),
    path("dashboard/sessions/<int:session_id>/edit/", views.owner_session_edit, name="owner_session_edit"),
    path("dashboard/sessions/<int:session_id>/archive/", views.owner_session_archive, name="owner_session_archive"),
]

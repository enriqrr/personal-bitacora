...
urlpatterns = [
    ...
    path("dashboard/search/", views.owner_search, name="owner_search"),
    path("dashboard/tags/", views.owner_tag_list, name="owner_tag_list"),
    path("dashboard/tags/new/", views.owner_tag_create, name="owner_tag_create"),
    path("dashboard/tags/<slug:slug>/", views.owner_tag_detail, name="owner_tag_detail"),
    path("dashboard/tags/<slug:slug>/edit/", views.owner_tag_edit, name="owner_tag_edit"),
    path("dashboard/tags/<slug:slug>/archive/", views.owner_tag_archive, name="owner_tag_archive"),
    ...
    path("dashboard/documents/<int:document_id>/tags/", views.owner_document_tags, name="owner_document_tags"),
